#!C:\Users\T4VJNPI.CN\Python\Python312\python.exe
import sys
...
# Original code        elif k == '-p': pagenos.update( int(x)-1 for x in v.split(',') )
        elif k == '-p': pagex, pagey = v.split('-') 
    ...
    for fname in args:
        with open(fname, 'rb') as fp:
            ...
            pagenos.update(range(int(pagex)-1,int(pagey)-1))
